...
export default function DrawerAdmin({ setShow, openChat }) {
    ...
    return (
        <div className='drawer-container'>
            ...
            <div className='drawer-element' onClick={() => setShow(3)}><img src={admin} className='drawer-icon' alt='admin'></img></div>
        </div>
    )
}